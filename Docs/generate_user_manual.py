...
def generate_manual():
    ...
    simple_table(
        ...
        [
            ...
            [VERSION_TAG, REVIEW_DATE, "AI-assisted",   "新增第 6 章圖表設計（戰情室看板、設計器、CRUD/匯出入、定期刷新）；原第 6~14 章順移為第 7~15 章；補充 5.6 調試操作的執行人員/強制安排說明；修正 4.1 導覽列圖表項說明"],
        ],
        [2.0, 2.5, 3.5, 8.0]
    )
    doc.add_page_break()
    ...
    note("結束調試時，執行人員、安排調試的人員或具備「系統設定」權限者皆可代為刷卡結束", kind="info")

    heading3("強制安排（系統設定權限）")
    body("具備「系統設定」權限的使用者可開啟對話框中的「強制安排」開關，跳過一般調試流程限制，"
