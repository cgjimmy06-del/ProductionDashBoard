...
namespace FProductionDashBoard.Repositories
{
    public interface IErrorListRepository : IRepository<ErrorList, MesDbContext>
    {
        ...
        public Task<List<(string ErrorCode, string Message, int TypeId)>> GetMessagesAsync(string languageCode);
        public Task<List<(string ErrorCode, string Message, int TypeId)>> GetMessagesWithOtherAsync(string languageCode);
